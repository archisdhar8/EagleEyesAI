...
_INTENTS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("OPPORTUNITY_RANKING", (
        ...
        "best ideas", "most attractive holdings", "best current setups",
    )),
    ("THESIS_REPLACEMENT", ("weakest investment thesis", "weakest thesis", "replace it with", "replacement for")),
    ("PORTFOLIO_CHANGE", (
        "materially changed in my portfolio", "changed materially in my portfolio",
        "portfolio since my last review", "portfolio changed since",
    )),
    ("VALUATION_RANKING", (
        "most overvalued", "overvalued relative to", "valuation relative to growth",
        "expensive relative to growth", "expensive relative to quality",
    )),
    ("HIDDEN_RISK", (
    ...
    ("MULTI_SCENARIO", (
        "what would happen to my portfolio", "what happens if rates", "interest rates rose",
        "rates stay high", "higher rates", "ai spending slowed", "ai spending slows",
        "ai capex declines", "hyperscaler spending weakens", "growth weakens",
        "economy entered a recession", "recession + higher rates",
    )),
    ("WATCHLIST_COMPARISON", ("watchlist stocks", "watchlist names", "stronger risk-adjusted case")),
    ("PORTFOLIO_EVENTS", (
        "upcoming earnings reports", "upcoming earnings", "upcoming events", "events matter most",
        "economic events", "economic releases", "company catalysts", "company events", "upcoming catalysts",
    )),
    ("DATA_QUALITY", (
        "missing reliable data", "trust their rankings", "trust these rankings", "data coverage",
        "missing data", "data is missing", "reliable is the data", "reliability of the data", "complete is the evidence",
    )),
    ...
    ("RECOMMENDATION_COUNTERCASE", (
        "arguments against", "argument against", "strongest counterargument", "counterargument to",
        "top recommendation", "current recommendation", "bear case", "bear case against",
        "make this recommendation wrong", "challenge this recommendation",
    )),
    ...
    ("PORTFOLIO_ANALYSIS", (
        "balanced alternative", "risk-controlled alternative", "lower-risk version", "lower risk version",
        "goal-tilted alternative", "rebalance", "rebalancing", "optimizer", "target weight",
        "allocation change", "improve diversification", "without silently changing my constraints",
        "move out", "exit candidates", "stocks to remove", "holdings to remove",
    )),
