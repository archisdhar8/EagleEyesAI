...
READ_MODEL_CALCULATION_VERSIONS = {
    ...
    "portfolio_risk": "portfolio-risk-read-v3",
    ...
    "portfolio_events": "portfolio-events-read-v3",
    "portfolio_data_quality": "portfolio-data-quality-read-v3",
...
def _model_payloads(portfolio: dict[str, Any], overview: dict[str, Any], *, profile: dict[str, Any],
    ...
    return {
        ...
        "portfolio_data_quality": {"holdings": holdings, "warnings": overview.get("warnings") or [],
                                   ...
                                   "classification_coverage": (intelligence.get("coverage") or {}).get("classification") or {}},
